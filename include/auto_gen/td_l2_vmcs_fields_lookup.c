...
const md_lookup_t td_l2_vmcs_lookup[MAX_NUM_TD_L2_VMCS_LOOKUP] = {
 ...
 },
 {
   ...
   .l1_vmm_rd_mask = (18446744073709551487ULL & 0xFFFFFFFFFFFFFFFFULL), .l1_vmm_wr_mask = (14ULL & 0xFFFFFFFFFFFFFFFFULL),
 ...
 },
 {
   ...
   .export_mask = (18446744073709543423ULL & 0xFFFFFFFFFFFFFFFFULL), .import_mask = (65473ULL & 0xFFFFFFFFFFFFFFFFULL),
   .mig_export = MIG_ME, .mig_import = MIG_ME,
   .special_rd_handling = false,
   .special_wr_handling = true 
 },
 ...
 },
 {
   ...
   .l1_vmm_rd_mask = (4244635647ULL & 0xFFFFFFFFULL), .l1_vmm_wr_mask = (1224317444ULL & 0xFFFFFFFFULL),
 ...
 },
 {
   ...
   .l1_vmm_rd_mask = (4294967295ULL & 0xFFFFFFFFULL), .l1_vmm_wr_mask = (206651148ULL & 0xFFFFFFFFULL),
 ...
 },
 {
   ...
   .num_of_fields = 1, .num_of_elem = 1, .attributes = { .raw = 0x0 },
   .prod_rd_mask = (0ULL & 0xFFFFFFFFFFFFFFFFULL), .prod_wr_mask = (0ULL & 0xFFFFFFFFFFFFFFFFULL),
   .dbg_rd_mask = (18446744073709551615ULL & 0xFFFFFFFFFFFFFFFFULL), .dbg_wr_mask = (67051455ULL & 0xFFFFFFFFFFFFFFFFULL),
   .l1_vmm_rd_mask = (18446744073709551615ULL & 0xFFFFFFFFFFFFFFFFULL), .l1_vmm_wr_mask = (67051455ULL & 0xFFFFFFFFFFFFFFFFULL),
   .export_mask = (-1ULL & 0xFFFFFFFFFFFFFFFFULL), .import_mask = (67051455ULL & 0xFFFFFFFFFFFFFFFFULL),
   .mig_export = MIG_ME, .mig_import = MIG_ME,
   .special_rd_handling = true,
   .special_wr_handling = true 
 },
